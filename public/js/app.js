...
/* harmony import */ var dropzone__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dropzone */ "./node_modules/dropzone/dist/dropzone.js");
 // Asegúrate de que Dropzone esté importado correctamente
//import '../css/app.css'; // Asegúrate de importar el archivo CSS

dropzone__WEBPACK_IMPORTED_MODULE_0__.autoDiscover = false; // Desactivar la autodetección de formularios Dropzone

document.addEventListener('DOMContentLoaded', function () {
  var dropzone = new dropzone__WEBPACK_IMPORTED_MODULE_0__('#dropzone', {
    // Asegúrate de que el selector esté apuntando correctamente
  ...
  dropzone.on("success", function (file, response) {
    ...
    console.log("Valor de la imagen en el campo oculto:", document.querySelector('[name="imagen"]').value);
  });
});
})();
